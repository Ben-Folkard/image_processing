...
/home/vol03/scarf1493/myenv/bin/python3 image_processing.py --video_filename "$video_filename" --average_time "$average_time" --max_chunks "$max_chunks" --step_size "$step_size"
